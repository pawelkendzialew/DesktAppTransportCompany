...
static constexpr auto qt_meta_stringdata_ZN16AddvehicleDialogE = QtMocHelpers::stringData(
    "AddvehicleDialog",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16AddvehicleDialogE[] = {
...
Q_CONSTINIT const QMetaObject AddvehicleDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16AddvehicleDialogE.offsetsAndSizes,
    qt_meta_data_ZN16AddvehicleDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16AddvehicleDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AddvehicleDialog, std::true_type>,
...
void *AddvehicleDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16AddvehicleDialogE.stringdata0))
